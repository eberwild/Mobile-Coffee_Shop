...
export default function Menu() {
  ...
  const headerComponent = (
    <View>
      <Text style={styles.header}>Top Coffees To Go</Text>
      <Image source={Cart} resizeMode="cover" />
    </View>
  );
          ...
          >
            <View style={styles.row}>
              <View style={styles.textRow}>
                <Text style={[styles.itemTitle, styles.menuItemText]}>
                  {item.title}
                </Text>
                <Text style={[styles.itemDescription, styles.menuItemText]}>
                  {item.description}
                </Text>
              </View>
              <Image
